<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $query = "SELECT * FROM result where student_id = '$usn' and class_id='$classid' and course_id='$courseid'";
        ...
        else
        {
            if($count==0){
                echo "<script>
                    ...
                    window.location.href = 'remove-result.php';
                  </script>";
            }
            else{
                $query1 = "DELETE FROM result WHERE student_id='$usn' AND class_id='$classid' AND course_id='$courseid'";
                $sql = mysqli_query($con, $query1);
                $query2 = "CALL `auto_result_id`();";
            ...
            <div class="sample">
                <div class="container">
                    ...
                    <div class="paths">
                        ...
                        <span class="pathsytle"> / Results / Remove results</span>
                    </div>
                    <div>
                        <div class="main">
